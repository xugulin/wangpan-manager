...
| 系统 | 包 | 大小 | 说明 |
|---|---|---|---|
| **Windows** | `wangpan-manager-V1.0.7-Windows.zip` | 约 466 MB | 解压即用（x64） |
| **Linux** | `wangpan-manager-V1.0.7-Linux.zip` | 约 905 MB | 解压即用（x86_64） |
...
**Windows 包与源码同步**：这份 V1.0.7 就是当前源码打的包。之前 V1.0.6 的资源是更早
构建的，所以还会看到 AI 页顶部那个 `builtin | 内置兜底 | 3 个模型` 小徽标 ——
它在源码里已经删掉（`tests`/截图均已复核），请用这一版验证。
